...
correct = False  # Indicates if the posture is correct during the squat
...
try:
    while True:
        ...
        try:
            ...
            if hip_angle < 100 and knee_angle < 90 and stage == "up":
                stage = "down"
                correct = True
                counter += 1
        ...
        cv2.imshow('Squat Tracker with RealSense', image)
